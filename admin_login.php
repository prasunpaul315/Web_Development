...
<section>
  <div class="log_img">
    ...
    <div class="box1">
        ...
        <h1 style="text-align: center; font-size: 25px;">Admin Login</h1>
 ...
 <?php
    ...
    {
      $count=0;
      $res=mysqli_query($db,"SELECT * FROM `admin_information` WHERE username='$_POST[username]' && password='$_POST[password]';");
